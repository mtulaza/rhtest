%global cartridgedir %{_libexecdir}/openshift/cartridges/bamboo

Summary:       Bamboo cartridge
Name:          openshift-origin-cartridge-bamboo
Version:       0.1
Release:       1%{?dist}
Group:         Development/Languages
License:       ASL 2.0
URL:           http://www.glintech.com
Source0:       https://bitbucket.org/GLiNTECH/openshift-bamboo-cartridge/downloads/%{name}-%{version}.tar.gz
Requires:      rubygem(openshift-origin-node)
Requires:      openshift-origin-node-util
Provides:      openshift-origin-cartridge-bamboo-0.1 = 2.0.0
Obsoletes:     openshift-origin-cartridge-bamboo-0.1 <= 1.99.9
BuildArch:     noarch
